Datas1<-fluidRow(
  shinydashboard::box(
    title = "Raw data links for DEA workflow benchmarking",
    background = "black",
    width = 12,
...
Datas2<-fluidRow(
  shinydashboard::box(title = "Quantification data for DEA workflow benchmarking",
                      background = "black",
                      width = 12,
...
Datas3<-fluidRow(
  shinydashboard::box(title = "DEA workflow benchmarking result data",
      background = "black",
      width = 12,
...
Datas4<-fluidRow(
  shinydashboard::box(title = "view data for M-VIDIA case studies",
                      background = "black",
                      width = 12,
                      h4("view data for Thyroid Nodule Classification (TNC) dataset are available at: "),

                      #column(4,downloadLink("DDA_exp", "DDA_expression_matrices; ")),
                      column(6,h5("Download from zenodo via the following link"),
                             a(href = "https://zenodo.org/records/13896351",
                      ...
                      hr(),
                      h4("Single Mouse Oocytes (SMO) data are available at: "),
                      #column(4,downloadLink("DDA_met", "DDA_performance_metrics; ")),
                      column(6,h5("Download from zenodo via the following link"),
                             a(href = "https://zenodo.org/records/13896351",
                               "Zenodo: proteomics;")),
                      ...
                      hr(),
                      h4("Pick-up Single-cell Proteomic Analysis (PiSPA) dataset are available at: "),
                      #column(4,downloadLink("DDA_rk", "DDA_workflow_ranks; ")),
                      column(6,h5("Download from zenodo via the following link"),
                             a(href = "https://zenodo.org/records/13896351",
